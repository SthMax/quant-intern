...
Goose & v1.50.1 & 当前官方仓库为aaif-goose/goose。\\
OpenClaw & v2026.9.4 & 个人/团队使用需结合官方信任模型。\\
...
Codex CLI & 正式release 0.154.0 & 本机包0.149.1，未升级或执行模型。\\
Claude Code & v2.1.273 & 商业许可与厂商支持范围单独判断。\\
\end{longtable}
}
...
\end{tabularx}
\source{对应项目LICENSE及产品说明。\src{TECH-043}\src{TECH-030}\src{TECH-045}\src{TECH-033}\src{TECH-034}\src{TECH-051}\src{TECH-039}}
\end{table}
