...
\hypersetup{colorlinks=true,linkcolor=teal,urlcolor=teal,bookmarksnumbered=true,pdftitle={基金公司LLM应用调研：应用实践、技术流程与项目建议},pdfauthor={Intern research},pdfsubject={2026 industry evidence, four LLM workflows, governance and Phase 2 handoff}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
