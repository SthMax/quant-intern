...
2. Click **Add credential** to add keys to the pool.
   ...
   <Frame>
     <img src="https://mintcdn.com/dify-6c0370d8/gyesM3ime6gTaYSO/images/use-dify/workspace/add-load-balancing-credential.png?fit=max&auto=format&n=gyesM3ime6gTaYSO&q=85&s=6bb088ed0ae69dc0ad838217c016d68d" alt="Add Credentials for Load Balancing" width="1194" height="872" data-path="images/use-dify/workspace/add-load-balancing-credential.png" />
   </Frame>
