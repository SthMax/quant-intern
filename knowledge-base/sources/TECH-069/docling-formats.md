Docling can parse various documents formats into a unified representation (Docling Document), which it can export to different formats too — check out [Architecture](../../concepts/architecture/) for more details.
...
| WAV, MP3, M4A, AAC, OGG, FLAC | Audio formats (requires `asr` extra — see [Processing audio and video](../processing_audio_media/)) |
...
| Docling JSON | JSON-serialized [Docling Document](../../concepts/docling_document/) |
