[MiMo-V2.6：扩展强化学习规模，迈向自我提升](/docs/zh-CN/news/latest/v2-6)

[Xiaomi MiMo 桌面客户端开放邀测](/docs/zh-CN/news/latest/mimo-desktop)

[关于 MiMo-V2.5-Pro-UltraSpeed 限时体验延期的通知](/docs/zh-CN/news/latest/beta-extended)

[Xiaomi MiMo Claw 正式版｜旗舰模型+金山办公，全新订阅服务上线](/docs/zh-CN/news/latest/mimoclaw)

[MiMo Code 发布并开源｜模型 Agent 协同优化，迈向自进化时代](/docs/zh-CN/news/latest/mimocode)

[Xiaomi MiMo 携手 TileRT｜1T 模型首次突破 1000 tokens/s 输出速度](/docs/zh-CN/news/latest/1000tps)

[MiMo-V2.5 系列推理全链路优化：将 Hybrid SWA 效率推向极致](/docs/zh-CN/news/latest/updqate)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/KYAEbDMMVoVHsexkfyOcv8HQnch.png)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/OaNDbA6znoG7HOxlWJJcWvsknHe.png)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/MhdfbCm3AokF6Hxakc6c0d5lnYb.png)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/PRlRbNId3oGwCwxi0wycqYjUnlc.png)

本次训练主要从三个维度扩展 RL 算力：

1. **更大的 Batch 与更高吞吐** ：结合大 Batch 和全异步架构，单次更新使用 **1,568 个样本** ，支持 **1M 上下文长度** 训练，单步训练 Token 达 **3.5～3.7B** 。
2. **更多任务与复杂环境** ：构建覆盖 Code、General、Visual、Cyber 等方向的多任务训练体系，并混合多个 Harness，促进 **不同能力维度协同提升** 。
3. **更大的 Grader 算力** ：通过 Group 内相对比较，为 Long-Horizon RL 任务提供更精准、多样的奖励信号，形成模型自我改进闭环，并 **引导模型以更短路径、更少 Token 完成任务** 。
...
<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/Cf4ybzne1oJPbBx2rM1cD2vXnBe.quicktime" controls="" title="9月21日(5).mov"></video>

**Blender 3D 建模**

MiMo-V2.6 能够根据用户的文字描述或参考图片，在 Blender 中完成物体与场景的三维建模，生成可用于动画制作、3D 打印与游戏开发的 3D 资产。

<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/BJjyberfPoV38sx07IuchbzinlU.mp4" controls="" title="car-ship-v4.mp4"></video>

**具身智能**

在具身仿真环境中，MiMo-V2.6 可以直接以多视角相机画面为输入，持续进行推理与决策，并通过视觉反馈闭环控制 Franka Panda 机械臂，完成物体抓取、颜色匹配与精准放置。

<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/NQ5ebH4KvoipY7xXXIFcH2NInTd.mp4" controls="" title="isaaclab-color-match_zh_with-cover.mp4"></video>

**Computer Use Agent**

MiMo-V2.6 进一步拓展了 Computer Use 能力，将多模态感知与原生训练的行动能力相结合。它可以理解复杂的图形界面，使用常见办公与生产力工具，完成信息检索、编辑和数据处理等任务，并根据视觉反馈检查结果、排查问题、调整后续行动。

<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/RW3WbZqLxo2oSSxHSh9cskPWnkh.mp4" controls="" title="computeruse 最终版本.mp4"></video>
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/Xw54brNqwoguv1xZ9e1c6LbVnAh.gif)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/IggpbYLGCoiAHXxFZxIcKkDxnph.gif)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/NMLvb9QzEoyWtLxkhsccSPBFngf.png)
...
<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/InZtbEISyoaAacxQaYbc5nFVnnb.mp4" controls="" title="前端审美已剪辑_双章节轻快版.mp4"></video>
...
<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/AJXTbNUF6oQrsZxo4CWcKLyUn6e.mp4" controls="" title="视频创作已剪辑_0.5秒开场版.mp4"></video>
...
<video src="https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/videos/BRz7b0OUmoUeS0xDjjpcnRxEnah.mp4" controls="" title="mimo-交响乐.mp4"></video>
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/LadHbthLYo3UZxx0GMbc67drnYe.png)
...
![图片](https://aistudio-cdn.xiaomimimo.com/xiaomimimo-static/mimo-docs-figures/display/CFceb5NaioiB8Cxx6eEcxUzZntf.png)

希望这次分享能为社区持续探索强化学习算法与智能体机制提供共同基础，推动 Agentic RL 研究不断向前。

开源链接： [https://huggingface.co/collections/XiaomiMiMo/mimo-v26](https://huggingface.co/collections/XiaomiMiMo/mimo-v26)
