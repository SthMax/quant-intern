...
| --- | --- | --- | --- |
| **[MiMo-V2.5-Pro](https://huggingface.co/XiaomiMiMo/MiMo-V2.5-Pro)** | **1.02T** | 42B | Text (multimodal planned) |
| **[MiMo-V2.5](https://huggingface.co/XiaomiMiMo/MiMo-V2.5)** | **310B** | 15B | Text, Image, Video, Audio |
...
| Workload | accept\_rate | accept\_length (max = 4) |
| --- | --- | --- |
