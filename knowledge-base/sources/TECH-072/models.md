...
Then `/model fav` or `/model grok` in chat. User aliases shadow built-in short names (`sonnet`, `kimi`, `opus`, etc.). See [Custom model aliases](about:/docs/reference/slash-commands#custom-model-aliases) for the full reference.
